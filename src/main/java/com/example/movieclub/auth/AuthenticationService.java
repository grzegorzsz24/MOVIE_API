...
import com.example.movieclub.auth.token.ConfirmationToken;
import com.example.movieclub.auth.token.ConfirmationTokenService;
import com.example.movieclub.config.JwtService;
import com.example.movieclub.domain.User;
import com.example.movieclub.domain.UserRole;
import com.example.movieclub.email.EmailSender;
